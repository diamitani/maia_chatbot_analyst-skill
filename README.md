# maia_chatbot_analyst

**Category:** 05-chatbot-marketing
**Source:** maia-chatbot-analyst.md
...
1. Clone this repository:
   ```bash
   git clone https://github.com/diamitani/maia_chatbot_analyst-skill.git
   ```
...
2. Import the skill into your agent framework:
   ...
   # For Hermes Agent
   skill_view(name='maia_chatbot_analyst')
   ```
